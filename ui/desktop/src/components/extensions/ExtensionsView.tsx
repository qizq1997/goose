...
const i18n = defineMessages({
  ...
  description: {
    ...
    defaultMessage:
      "These extensions use the Model Context Protocol (MCP). They can expand QiaotongAgent's capabilities using three main components: Prompts, Resources, and Tools. {searchShortcut} to search.",
  },
  defaultNote: {
