...
const i18n = defineMessages({
  ...
  previewDescription: {
    ...
    defaultMessage:
      'Enable remote access to QiaotongAgent from mobile devices using secure tunneling.',
  },
  getIosApp: {
  ...
  qrCodeInstructions: {
    ...
    defaultMessage:
      'Scan this QR code with the QiaotongAgent mobile app. Do not share this code with anyone else as it is for your personal access.',
  },
  connectionDetails: {
  ...
  downloadIosApp: {
    ...
    defaultMessage: 'Download QiaotongAgent iOS App',
  },
  appStoreQrInstructions: {
    id: 'tunnelSection.appStoreQrInstructions',
    defaultMessage:
      'Scan this QR code with your iPhone camera to install the QiaotongAgent mobile app from the App Store',
  },
  openInAppStore: {
