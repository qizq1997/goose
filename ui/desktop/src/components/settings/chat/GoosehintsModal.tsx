...
const i18n = defineMessages({
  ...
  dialogDescription: {
    ...
    defaultMessage:
      'Provide additional context about your project to improve communication with QiaotongAgent',
  },
  helpText1: {
    id: 'goosehintsModal.helpText1',
    defaultMessage:
      '.goosehints is a text file used to provide additional context about your project and improve the communication with QiaotongAgent.',
  },
  helpText2: {
