...
const i18n = defineMessages({
  ...
  modeDescription: {
    ...
    defaultMessage: 'Configure how QiaotongAgent interacts with tools and extensions',
  },
  responseStylesTitle: {
  ...
  responseStylesDescription: {
    ...
    defaultMessage: 'Choose how QiaotongAgent should format and style its responses',
  },
});
