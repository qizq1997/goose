...
const i18n = defineMessages({
  ...
  focusWindowLabel: {
    ...
    defaultMessage: 'Focus QiaotongAgent Window',
  },
  focusWindowDescription: {
    id: 'keyboardShortcuts.focusWindowDescription',
    defaultMessage: 'Bring QiaotongAgent window to front from anywhere',
  },
  quickLauncherLabel: {
  ...
  newChatWindowDescription: {
    ...
    defaultMessage: 'Open a new QiaotongAgent window',
  },
  openDirectoryLabel: {
  ...
  categoryGlobalDescription: {
    ...
    defaultMessage: 'These shortcuts work system-wide, even when QiaotongAgent is not focused',
  },
  categoryApplication: {
  ...
  categoryApplicationDescription: {
    ...
    defaultMessage: 'These shortcuts work when QiaotongAgent is the active application',
  },
  categorySearch: {
  ...
  restartDescription: {
    ...
    defaultMessage:
      'Changes to application shortcuts (like New Chat, Settings, etc.) require restarting QiaotongAgent to take effect. Global shortcuts (Focus Window, Quick Launcher) work immediately.',
  },
  dismiss: {
