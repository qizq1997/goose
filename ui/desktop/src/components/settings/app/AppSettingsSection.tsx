...
const i18n = defineMessages({
  ...
  appearanceDesc: {
    ...
    defaultMessage: 'Configure how QiaotongAgent appears on your system',
  },
  ...
  themeDesc: {
    ...
    defaultMessage: 'Customize the look and feel of QiaotongAgent',
  },
  helpTitle: { id: 'settings.help.title', defaultMessage: 'Help & feedback' },
  helpDesc: {
    id: 'settings.help.description',
    defaultMessage: 'Help us improve QiaotongAgent by reporting issues or requesting new features',
  },
  ...
  updatesDesc: {
    ...
    defaultMessage: 'Check for and install updates to keep QiaotongAgent running at its best',
  },
  ...
  notificationsMacStep3: {
    ...
    defaultMessage: 'Find and select QiaotongAgent in the application list',
  },
