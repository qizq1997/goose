    ...
    <div className="space-y-6">
      ...
      {(status === 'stopped' || status === 'unknown') && (
        <div className="border border-border-subtle rounded-xl p-4 bg-background-default space-y-4">
          ...
          <p className="text-xs text-text-muted">
            When you start the mesh, keep QiaotongAgent running to stay connected.
          </p>
        </div>
      )}
      ...
      {status === 'running' && (
        <>
          ...
          {statusInfo.models.length > 0 && (
            <div>
              ...
              <p className="text-xs text-text-muted mb-3">
                Select a model to use it as your QiaotongAgent provider.
              </p>
          ...
          <p className="text-xs text-text-muted">
            Keep QiaotongAgent running to stay connected to the mesh.
          </p>
