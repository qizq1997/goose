...
const i18n = defineMessages({
  ...
  description: {
    ...
    defaultMessage:
      'Anonymous usage data helps us understand how QiaotongAgent is used and identify areas for improvement.',
  },
  whatWeCollect: {
  ...
  collectVersion: {
    ...
    defaultMessage: 'QiaotongAgent version and install method',
  },
  collectProvider: {
