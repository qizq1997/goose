...
const i18n = defineMessages({
  ...
  allSet: {
    ...
    defaultMessage: "You're all set to start using QiaotongAgent.",
  },
  privacyTitle: {
  ...
  privacyDescription: {
    ...
    defaultMessage:
      'Anonymous usage data helps improve QiaotongAgent. We never collect your conversations, code, or personal data.',
  },
  learnMore: {
