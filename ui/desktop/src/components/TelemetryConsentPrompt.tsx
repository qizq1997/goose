...
const i18n = defineMessages({
  heading: {
    ...
    defaultMessage: 'Help improve QiaotongAgent',
  },
  description: {
    id: 'telemetryConsentPrompt.description',
    defaultMessage:
      'Would you like to share anonymous usage data to help improve QiaotongAgent? We never collect your conversations, code, or personal data.',
  },
  learnMore: {
